...
use Turahe\MailClient\Client\Exceptions\RateLimitExceededException;
use Turahe\MailClient\Client\Exceptions\ServiceUnavailableException;
use Turahe\MailClient\Client\Exceptions\UnauthorizedException;
...
class ImapClient extends AbstractImapClient
{
     ...
     *
     * @param  string  $id
     * @return \Turahe\MailClient\Client\Gmail\Message
     */
     ...
     *
     * @return \Turahe\MailClient\Client\Gmail\Message|null
     */
     ...
     *
     * @param  mixed  $folder
     * @return \Turahe\MailClient\Client\Gmail\Folder
     */

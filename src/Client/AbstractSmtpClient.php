...
abstract class AbstractSmtpClient implements SmtpInterface
{
     ...
     *
     * @var \Turahe\MailClient\Client\Contracts\ImapInterface|\Turahe\MailClient\Client\AbstractImapClient
     */
    protected $imap;
     ...
     *
     * @param  \Turahe\MailClient\Client\Contracts\ImapInterface  $client
     * @return static
     */
     ...
     *
     * @param  \Turahe\MailClient\Client\Contracts\MessageInterface  $message  Previous message

...
use Turahe\Core\Common\Microsoft\Services\Batch\BatchGetRequest;
use Turahe\Core\Common\Microsoft\Services\Batch\BatchPatchRequest;
...
use Turahe\Core\Common\OAuth\AccessTokenProvider;
...
use Turahe\MailClient\Client\Exceptions\MessageNotFoundException;
use Turahe\MailClient\Client\Exceptions\ServiceUnavailableException;
use Turahe\MailClient\Client\FolderIdentifier;
use Turahe\MailClient\Client\MasksMessages;
...
class ImapClient extends AbstractImapClient
{
     ...
     *
     * @param  string  $id
     * @return \Turahe\MailClient\Client\Outlook\Message
     *

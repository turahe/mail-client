...
use Turahe\MailClient\Client\Contracts\SupportSaveToSentFolderParameter;
...
class SmtpClient extends AbstractSmtpClient implements SupportSaveToSentFolderParameter
{
     ...
     * Send mail message
     *
     * @return null|\Turahe\MailClient\Client\Contracts\MessageInterface
     */
     ...
     *
     * @param  \Turahe\MailClient\Client\Outlook\Message|null  $repliesTo
     * @return array
     */
     ...
     *
     * @param  \Turahe\MailClient\Client\Outlook\Message  $message

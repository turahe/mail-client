...
use Turahe\MailClient\Client\Contracts\ImapInterface;
use Turahe\MailClient\Client\Contracts\MessageInterface;
use Turahe\MailClient\Client\Contracts\SmtpInterface;
use Turahe\MailClient\Client\Events\MessageSending;
use Turahe\MailClient\Client\Events\MessageSent;
...
class Client implements ImapInterface, SmtpInterface
{
     ...
     *
     * @param  \Turahe\MailClient\Client\Contracts\SmtpInterface&\Turahe\MailClient\Client\AbstractSmtpClient  $smtp
     */
     ...
     * @return \App\MailClient\Client\Contracts\Masks\Folder
     *
     ...
     * Send mail message
     *
     * @return \Turahe\MailClient\Client\Contracts\MessageInterface|null
     */
     ...
     * Get the sent folder
     *
     * @return \Turahe\MailClient\Client\Contracts\FolderInterface
     */
     ...
     * Get the IMAP client
     *
     * @return \Turahe\MailClient\Client\Contracts\ImapInterface
     */
     ...
     * Get the SMTP client
     *
     * @return \Turahe\MailClient\Client\Contracts\SmtpInterface
     */

...
use Turahe\MailClient\Client\Compose\MessageForward;
use Turahe\MailClient\Client\Compose\MessageReply;
use Turahe\MailClient\Concerns\EmailAccountImap;
...
class EmailAccount extends Model
{
    ...
    {
        return $this->hasMany(\Turahe\MailClient\Models\EmailAccountMessage::class);
    }
    ...
    {
        return $this->hasMany(\Turahe\MailClient\Models\EmailAccountFolder::class);
    }
    ...
    {
        return $this->belongsTo(\Turahe\MailClient\Models\EmailAccountFolder::class);
    }
